...
int n_props, iv, ik, it, ie, iw, ip, r = 0;
...
double stima_pot, stima_pres, stima_kin, stima_etot, stima_temp, stima_p, stima_g;
double err_pot, err_press, err_kin, err_etot, err_temp, err_gdir, err_p;
